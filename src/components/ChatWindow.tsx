...
import { useSendMessage, useChatMessages, useMarkMessagesAsRead, IChatMessage } from "../features/chat/api/chatApi";
...
export const ChatWindow = memo(({ chatRoom, onClose }: ChatWindowProps) => {
    ...
    const { emitEvent, onEvent, offEvent, joinRoom, leaveRoom } = useSocket();
