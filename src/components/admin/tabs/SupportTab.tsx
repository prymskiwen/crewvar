    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">All Support Tickets</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition-colors">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm font-medium text-gray-900">View All Tickets</p>
              <p className="text-xs text-gray-500">Browse all support requests</p>
            </div>
          </button>
          ...
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition-colors">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm font-medium text-gray-900">Create Response</p>
              <p className="text-xs text-gray-500">Draft a support response</p>
            </div>
          </button>
          ...
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition-colors">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500">View support metrics</p>
            </div>
          </button>
        </div>
      </div>
