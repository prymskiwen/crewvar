...
const Footer = () => {
    ...
    const handleEmailClick = async () => {
        try {
            ...
            const mailtoLink = 'mailto:support@crewvar.com?subject=Support Request';
            window.location.href = mailtoLink;
            
            // If that doesn't work, copy to clipboard as fallback
            setTimeout(async () => {
                try {
                    await navigator.clipboard.writeText('support@crewvar.com');
                    ...
                    toast.info('Email: support@crewvar.com', {
                        position: "top-right",
                        autoClose: 5000,
                    });
                }
            ...
            console.error('Error with email link:', error);
            // Fallback: show email in toast
            toast.info('Email: support@crewvar.com', {
                position: "top-right",
                autoClose: 5000,
            });
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <button
                                    ...
                                    className="text-white/80 hover:text-white transition-colors text-sm flex items-center cursor-pointer bg-transparent border-none p-0"
                                >
