...
export const CrewMemberProfile = () => {
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">
              This crew member profile could not be found.
            </p>
            {!!error && (
  ...
  if (process.env.NODE_ENV === "development") {
    console.log(
      "CrewMemberProfile - profile.displayName:",
      profile?.displayName,
      "isLevel1:",
      isLevel1,
      "isLevel2:",
    ...
    console.log("CrewMemberProfile:", profile);
  }
  ...
  const handleSendConnectionRequest = async () => {
    ...
    try {
      ...
      console.error("Failed to send connection request:", error);
      toast.error(
        error.message || "Failed to send connection request. Please try again.",
        {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
              ...
              <div className="bg-gradient-to-r from-[#069B93] to-[#00A59E] p-4 sm:p-6 text-white">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <div className="relative">
                      ...
                      <div
                        className={`absolute -bottom-1 -right-1 w-6 h-6 border-2 border-white rounded-full ${
                          profile.isOnline ? "bg-green-400" : "bg-red-400"
                        }`}
                      ></div>
                    </div>
                  </div>
                  <div className="text-center sm:text-left flex-1">
                    ...
                    <p className="text-[#B9F3DF] text-base sm:text-lg">
                    ...
                    <div className="flex items-center justify-center sm:justify-start space-x-2 mt-2">
                      ...
                      <span
                        className={`text-sm ${
                          profile.isOnline ? "text-[#B9F3DF]" : "text-[#f3bdb9]"
                        }`}
                      >
                        {profile.isOnline ? "Online now" : "Offline Now"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 sm:p-6 space-y-6">
                  ...
                  {isReferenceDataLoading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                        ...
                        <p className="text-gray-600 text-sm sm:text-base">
                          {getShipName(profile.currentShipId || "")}
                        </p>
                      </div>
                    </div>
                  )}
                ...
                {isLevel1 && (
                  <div className="text-center py-8 sm:py-12">
                    ...
                    <p className="text-gray-600 mb-6 text-sm sm:text-base px-4">
                      Send a connection request to see bio, photos, contacts,
                ...
                {isLevel2 && (
                  <div className="space-y-6">
                    ...
                    {(profile.photos || profile.additional_photos) &&
                      (profile.photos || profile.additional_photos)?.length >
                        0 && (
                        <div>
                          <h2 className="text-lg font-semibold text-gray-900 mb-3">
                            Photos
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <a
                                    ...
                                    className="text-blue-600 hover:text-blue-800 text-xs sm:text-sm truncate block"
                                  >
                                    {profile.instagram ||
                                      profile.instagram_handle}
                                  </a>
