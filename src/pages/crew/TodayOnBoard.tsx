    ...
    const filteredCrew = useMemo(() => {
        ...
        return allCrew.filter((member: any) => {
            const matchesSearch = !searchQuery ||
                ...
                getRoleName(member.roleId).toLowerCase().includes(searchQuery.toLowerCase()) ||
                getDepartmentName(member.departmentId).toLowerCase().includes(searchQuery.toLowerCase());
            ...
            <DashboardLayout>
                <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">Failed to Load Crew</h3>
                        <p className="text-gray-600 mb-4">Unable to load crew members from your ship.</p>
                        <button
            ...
            <div className="bg-teal-600 text-white p-3 sm:p-4 sticky top-0 z-10">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        <div>
                            <h1 className="text-base sm:text-lg font-bold">Today on Board</h1>
                                <p className="text-xs text-teal-100">Crew members on your ship</p>
                            </div>
                    </div>
                ...
                <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-3 sm:p-4">
                        <h2 className="text-base sm:text-lg font-semibold text-teal-600 mb-3">Search Crew Members</h2>
                            ...
                            {filteredCrew.length === 0 ? (
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    {filteredCrew.map((member: any) => (
                                        <div key={member.id} className="bg-gray-50 rounded-lg p-3 sm:p-4 hover:bg-gray-100 transition-colors">
