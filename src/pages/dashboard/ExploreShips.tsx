...
export const ExploreShips = () => {
  ...
  // Fetch crew members with infinite scroll - only when user has applied search or filters
    ...
    queryKey: ["crewMembers", selectedShipId, searchQuery, selectedRole], // Include selectedRole in key
    queryFn: ({ pageParam = 0 }) =>
      getCrewMembers({
    ...
    enabled:
      !!currentUser &&
      (!!searchQuery?.trim() || !!selectedShipId || !!selectedCruiseLine || !!selectedRole),
    });
    ...
    return (
        <DashboardLayout>
            ...
            <h2 className="text-base sm:text-lg font-semibold text-teal-600 mb-3">
              ...
              {(selectedCruiseLine || selectedShip || selectedRole || searchQuery) && (
                <button
                ...
                >
                  Clear All Filters
                    ...
                    {/* Loading State */}
          {(cruiseLinesLoading || shipsLoading || (crewLoading && (!!searchQuery?.trim() || !!selectedShipId || !!selectedCruiseLine || !!selectedRole))) && (
          ...
          {!cruiseLinesLoading && !shipsLoading && (!!searchQuery?.trim() || !!selectedShipId || !!selectedCruiseLine || !!selectedRole) && (
                        <div className="bg-white rounded-lg shadow-sm border p-4">
