...
export const TodayOnBoardCard = () => {
  ...
  const sendConnectionRequestMutation = useMutation({
    mutationFn: async (data: { receiverId: string; message?: string }) => {
      ...
      console.log(
        "🔗 TodayOnBoardCard: About to call sendConnectionRequest with:",
        {
      ...
      console.log(
        "🔗 TodayOnBoardCard: Connection request sent, result:",
        result
      );
      return result;
    },
    ...
    onError: (error: any) => {
      console.error(
        "🔗 TodayOnBoardCard: Failed to send connection request:",
        error
      );
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-4">
            Please complete your onboarding to see crew members on your ship.
          </p>
          <button
        ...
        {crew.length > 0 ? (
              ...
              <CrewMemberCard
                ...
                member={{
                  ...
                  department:
                    ...
                    "Not specified",
                  avatar: getProfilePhotoUrl(
                    member.profilePhoto || member.profile_photo
                  ),
                  shipName: member.shipName || member.ship_name,
                  cruiseLineName:
                    member.cruiseLineName || member.cruise_line_name,
          ...
          <div className="text-center py-4">
            ...
            <p className="text-gray-500 text-xs">
              No other active members seem to be on your ship today.
            </p>
          </div>
        )}
      </div>
